...
How algorithms solve the general case of problems?
 ...
 4. If the first number is grsater than the second number then the first number is greatest
 5. else the second number is the greatest
 6. Stop
 • Examine the above algorithm, though the algorithm is intended to find the largest among numbers 3 and 5 it is written as
 a generalized algorithm that can find the largest among any two given numbers.
