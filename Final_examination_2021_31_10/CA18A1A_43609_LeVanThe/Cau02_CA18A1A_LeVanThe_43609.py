...
def Cau2():
    ...
    def cv23():
        ...
        # mở file
        f = open("CA18A1A_LeVan The_43609_inp.txt", mode="r", encoding="utf-8")
        ...
        f.close()
        print("=="*10)
        print(" > Hoàn thành việc nhập dữ liệu từ file: CA18A1A_Le Van The_43609_inp.txt")
    ...
    def cv25():
        if len(data) == 8:
            print("Bạn cần chọn nhập thông tin về mặt hàng")
             ...
             # ghi dữ liệu
             f = open("CA18A1A_Le Van The_43609_out.txt", mode="w", encoding="utf-8")
             ...
             for i in data:
                 ...
                 f.write(s)
             f.close()
             print("Hoan thanh ghi ra file: CA18A1A_Le Van The_43609_out.txt")
             print("++"*20)
    ...
    def cau25():
        ...
        for i in data:
            ...
            mathangdatnhat_str = mathangdatnhat.ma_mat_hang + "|" + mathangdatnhat.ten_mat_hang + "|" + str(
                mathangdatnhat.so_luong) \
